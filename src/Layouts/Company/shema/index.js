...
const schemacompany = yup.object({
    ...
    companyEmail: yup.string().email(`Company Email must be xxx@xxxxx.xxx`).matches(/^.+\.(com|co\.id|co)$/i, `Company Email must be xxx@xxxxx.xxx`).required(`${textPlease} Company Email`),
