...
const schemacompany = yup.object({
    ...
    companyEmail: yup.string().email(`Company Email must be xxx@xxxxx.xx`).required(`${textPlease} Company Email`).matches(/^.+\.([a-zA-Z]{2,})$/i, `Company Email must be xxx@xxxxx.xx`),
    npwp: yup.string().required(`${textPlease} NPWP`).matches(/^(?:\s*\d{2})[.](\d{3})[.](\d{3})[.](\d-)(\d{3})[.](\d{3}\s*)$/g, `${textPlease} NPWP must be xx.xxx.xxx.x-xxx.xxx`),
